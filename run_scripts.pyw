...
def run_main3():
    ...
    subprocess.run(['python', r'C:\Users\49176\Desktop\Final-Project\bis_du_da\Abschluss-Project\main3.py'])

def run_main4():
    # Full path to main4.py
    subprocess.run(['python', r'C:\Users\49176\Desktop\Final-Project\bis_du_da\Abschluss-Project\main4.py'])
